...
def main():
    ...
    raw_df = pd.read_csv(raw_path, encoding="utf-8-sig", engine="python", on_bad_lines="skip")
    ...
    for cpath in clean_files:
        try:
            cdf = pd.read_csv(cpath, encoding="utf-8-sig", engine="python", on_bad_lines="skip")
